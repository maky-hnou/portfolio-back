...
```bash
PORTFOLIO_BACKEND_RELOAD="True"
PORTFOLIO_BACKEND_PORT="8000"
PORTFOLIO_BACKEND_ENVIRONMENT="dev"
```
...
```
docker run -p "5432:5432" -e "POSTGRES_PASSWORD=portfolio_backend" -e "POSTGRES_USER=portfolio_backend" -e "POSTGRES_DB=portfolio_backend" postgres:13.8-bullseye
```
